...
class MonPDO {
    private const HOST_NAME = "mysql-margotte.alwaysdata.net";
    private const DB_NAME = "catalogue_margotte";
    private const USER_NAME = "margotte";
    private const PWD = "Shalom1303";
